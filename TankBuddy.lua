...
function TB_OnEvent(event)
	...
	if(event == "COMBAT_LOG_EVENT_UNFILTERED") then
		if ((arg2 == "SPELL_AURA_APPLIED") and (arg7 == TBmyname) and (arg10 == TB_FR)) then    -- Checks for Fel Rage
			TBfeltime = GetTime();
 		elseif ((englishClass == "WARRIOR") and (arg4 == TBmyname)) then
			if ((arg2 == "SPELL_MISSED") and (arg10 == TB_Taunt) and (arg12 == "RESIST")) then 	-- Checks if your taunt was resisted
				TBbadmob = arg7;
			...
			elseif ((arg2 == "SPELL_CAST_SUCCESS") and (arg10 == TB_CS)) then
				TBAbility = TB_GUI_CS;
			elseif ((arg2 == "SPELL_CAST_SUCCESS") and (arg4 == TBmyname) and (arg10 == TB_MB)) then	-- Checks if your mocking blow was hit
				if (TBSettings[TBSettingsCharRealm].MBRecoveryStatus) then
					TBRecovery = 1;
					TBbadmob = arg7;
					TBAbility = TB_GUI_Taunt;	-- Recovered taunts are handled like failed taunts.
				end
				if ((arg2 == "SPELL_MISSED") and (arg4 == TBmyname) and (arg10 == TB_MB)) then	-- If your mocking blow didnt hit, then do ..
					TBbadmob = arg7;
					TBAbility = TB_GUI_MB;
				end
			end
		elseif ((englishClass == "DRUID") and (arg4 == TBmyname)) then
			if ((arg2 == "SPELL_MISSED") and (arg10 == TB_Growl) and (arg12 == "RESIST")) then 	-- Checks if your taunt was resisted
				TBbadmob = arg7;
		...
		elseif ((englishClass == "PALADIN") and (arg4 == TBmyname)) then
			if ((arg2 == "SPELL_MISSED") and (arg10 == TB_RD) and (arg12 == "RESIST")) then 	-- Checks if righteous defense resisted
				TBbadmob = arg7;
				TBAbility = TB_GUI_RD;
			end
	...
	elseif (event == "PLAYER_AURAS_CHANGED" or event == "UPDATE_SHAPESHIFT_FORMS") then
		...
		if (TBSettings[TBSettingsCharRealm].DefensiveBearBuffstatus) then
			...
			if GetPlayerBuffName(TB_GUI_RF) then
				TBpallytanking = 1;
			end
...
function TB_Announce(TBAbility, TBTest)
	if (TBAbility) then
		...
		if (TBText) then
			if (TBAbility == TB_GUI_Taunt or TBAbility == TB_GUI_MB or TBAbility == TB_GUI_Growl or TBAbility == TB_GUI_RD) then
